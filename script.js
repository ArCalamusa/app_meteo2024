...
function getDevicePosition() {
    //aquisizione posizione dispositivo
...
async function onPositionAcquired(position) {
    ...
    //navigazione a schermata di risultato
...
async function getImageData(weatherData) {
    ...
    const prompt = `Un immagine fotorealistica di ${location} con condizioni meteo ${conditions}, che mostra una vista suggestiva di un punto di riferimento della città delle strade, con un illuminazione calda e dorata.`
